...
@interface XKPresentationController ()
...
@implementation XKPresentationController
...
- (void)presentationTransitionWillBegin {
    ...
    // 启用手势交互功能
    if (_configuration.isEnableInteractiveTransitioning && _configuration.direction != XKTransitionDirectionCenter) {
